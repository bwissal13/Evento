                            ...
                            <ul class="event-list">
                                <li>
                                    <span class="img-thumb">
                                        <a href="single-event.html">
                                            <img width="70" height="100" src="{{ asset('img/upcoming-event-1.png') }} " alt="table-1-1">
                                         </a>
                                    </span>
                                ...
                                <li>
                                    <span class="img-thumb">
                                        <a href="single-event.html">
                                            <img width="70" height="100" src="{{ asset('img/upcoming-event-2.png') }} " alt="table-1-2"> 
                                        </a>
                                    </span>
                                ...
                                <li>
                                    <span class="img-thumb">
                                        <a href="single-event.html">
                                            <img width="70" height="100" src="{{ asset('img/upcoming-event-3.png') }} " alt="table-1-3"> 
                                        </a>
                                    </span>
                                    <p><span>Date :</span> <a href="#">26/03/2021</a></p>
                                ...
                                <li>
                                    <span class="img-thumb">
                                        <a href="single-event.html">
                                            <img width="70" height="100" src="{{ asset('img/upcoming-event-4.png') }} " alt="table-1-4">
                                         </a>
                                    </span>
                                ...
                                <li>
                                    <span class="img-thumb">
                                        <a href="single-event.html">
                                            <img width="70" height="100" src=" {{ asset('img/upcoming-event-5.png') }}" alt="table-1-5"> 
                                        </a>
                                    </span>
