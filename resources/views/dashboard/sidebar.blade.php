    ...
    <div class="grid grid-cols-12 mx-auto gap-2 sm:gap-4 md:gap-6 lg:gap-10 xl:gap-14 max-w-7xl my-10 px-2">
        <div id="menu" class="bg-white/10 col-span-3 rounded-lg p-4 ">
            <h1
                ...
                Evento<span class="text-indigo-400">.</span></h1>
                ...
                <a href="{{ route('reservations.index') }}"
                    ...
                    <div class="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 group-hover:text-indigo-400">
                                <!-- Placeholder SVG icon for reservations -->
                                <rect width="24" height="24" fill="none" rx="0" ry="0"
                                    stroke="none" stroke-width="2"></rect>
                            </svg>
                        </div>
                        <div>
                            <p
                                class="font-bold text-base lg:text-lg text-slate-200 leading-4 group-hover:text-indigo-400">
                                Reservations</p>
                            <p class="text-slate-400 text-sm hidden md:block">View your reservations</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="{{ route('tickets.index') }}"
                    ...
                    <div class="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 group-hover:text-indigo-400">
                                <!-- Placeholder SVG icon for generating tickets -->
                                <rect width="24" height="24" fill="none" rx="0" ry="0"
                                    stroke="none" stroke-width="2"></rect>
                            </svg>
                        </div>
                        <div>
                            <p
                                class="font-bold text-base lg:text-lg text-slate-200 leading-4 group-hover:text-indigo-400">
                             Tickets</p>
                            <p class="text-slate-400 text-sm hidden md:block">Tickets Historique</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="{{ route('users.index') }}"
                    ...
                    <div class="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 group-hover:text-indigo-400">
                                <!-- Placeholder SVG icon for users -->
                                <rect width="24" height="24" fill="none" rx="0" ry="0"
                                    stroke="none" stroke-width="2"></rect>
                            </svg>
                        </div>
                    ...
                    <div class="flex flex-col space-y-2 md:flex-row md:space-y-0 space-x-2 items-center">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 group-hover:text-indigo-400">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M17.707 6.293a1 1 0 00-1.414 1.414L19.586 12l-3.293 3.293a1 1 0 101.414 1.414l4-4a1 1 0 000-1.414l-4-4a1 1 0 00-.707-.293zM4 12h14" />
                            </svg>
                        </div>
                        <div>
                            <p
