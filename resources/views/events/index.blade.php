...
@section('content')
    ...
    <div id="last-events" class="p-4">
        <h1 class="font-bold py-4 uppercase">Events</h1>
        <div class="flex justify-between items-center mb-4">
            <h1 class="font-bold text-2xl uppercase">Events</h1>
            <a href="{{ route('events.create') }}" class="bg-custom-color hover:bg-gray-700 text-white py-2 px-4 rounded-lg focus:outline-none focus:ring focus:border-blue-300 transition-all duration-300">Create Event</a>
